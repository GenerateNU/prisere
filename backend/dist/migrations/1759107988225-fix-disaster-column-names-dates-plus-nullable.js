export class FixDisasterColumnNamesDatesPlusNullable1759107988225 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "fema_disaster" ALTER COLUMN "fipsStateCode" TYPE integer USING "fipsStateCode"::integer`);
