...
var ErrorBoundary2 = async ({ children, fallback, fallbackRender, onError }) => {
  ...
  const fallbackRes = (error) => {
    ...
    return (fallbackStr || (fallbackRender == null ? void 0 : fallbackRender(error)) || "").toString();
  };
  let resArray = [];
  try {
    ...
    fallbackStr = await (fallback == null ? void 0 : fallback.toString());
    if (e instanceof Promise) {
      resArray = [
  ...
  if (resArray.some((res) => res instanceof Promise)) {
    fallbackStr || (fallbackStr = await (fallback == null ? void 0 : fallback.toString()));
...
<\/script>`;
          if (htmlArray.every((html2) => {
            var _a;
            return !((_a = html2.callbacks) == null ? void 0 : _a.length);
          })) {
            if (buffer) {
          ...
          const promises = callbacks.map(
            (c) => (...args) => {
              var _a;
              return (_a = c(...args)) == null ? void 0 : _a.then((content2) => {
                resolvedCount++;
                if (buffer) {
