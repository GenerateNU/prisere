...
var JSXNode = class {
  ...
  toString() {
    var _a, _b;
    const buffer = [""];
    (_a = this.localContexts) == null ? void 0 : _a.forEach(([context, value]) => {
      context.values.push(value);
    });
    try {
      this.toStringToBuffer(buffer);
    } finally {
      (_b = this.localContexts) == null ? void 0 : _b.forEach(([context]) => {
        context.values.pop();
      });
    }
...
var shallowEqual = (a, b) => {
  ...
  for (let i = 0, len = aKeys.length; i < len; i++) {
    if (aKeys[i] === "children" && bKeys[i] === "children" && !((_a = a.children) == null ? void 0 : _a.length) && !((_b = b.children) == null ? void 0 : _b.length)) {
      continue;
...
//# sourceMappingURL=chunk-TZZKEWTN.js.map
