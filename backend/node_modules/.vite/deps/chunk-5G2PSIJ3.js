...
var documentStartViewTransition = (cb) => {
  if (document == null ? void 0 : document.startViewTransition) {
...
var useViewTransition = () => {
  ...
  return [!!(viewTransitionState == null ? void 0 : viewTransitionState[0]), startViewTransition];
};
var pendingStack = [];
    ...
    for (let key in oldAttributes) {
      ...
      if (key !== "children" && !(key in attributes)) {
        ...
        if (eventSpec) {
          ...
          (_a = refCleanupMap.get(container)) == null ? void 0 : _a();
        } else {
...
var getNextChildren = (node, container, nextChildren, childrenToRemove, callbacks) => {
  var _a, _b;
  if ((_a = node.vR) == null ? void 0 : _a.length) {
    childrenToRemove.push(...node.vR);
    delete node.vR;
  }
  if (typeof node.tag === "function") {
    (_b = node[DOM_STASH][1][STASH_EFFECT]) == null ? void 0 : _b.forEach((data) => callbacks.push(data));
  }
  node.vC.forEach((child) => {
    ...
    if (isNodeString(child)) {
      ...
      if (typeof child.tag === "function" || child.tag === "") {
        ...
        nextChildren.push(child);
        if ((_a2 = child.vR) == null ? void 0 : _a2.length) {
...
var removeNode = (node) => {
  ...
  if (!isNodeString(node)) {
    (_b = (_a = node[DOM_STASH]) == null ? void 0 : _a[1][STASH_EFFECT]) == null ? void 0 : _b.forEach((data) => {
      var _a2;
      return (_a2 = data[2]) == null ? void 0 : _a2.call(data);
    });
    (_c = refCleanupMap.get(node.e)) == null ? void 0 : _c();
    if (node.p === 2) {
      (_d = node.vC) == null ? void 0 : _d.forEach((n) => n.p = 2);
    }
    (_e = node.vC) == null ? void 0 : _e.forEach(removeNode);
  }
  if (!node.p) {
    (_f = node.e) == null ? void 0 : _f.remove();
    delete node.e;
  }
  if (typeof node.tag === "function") {
...
var applyNodeObject = (node, container, isNew) => {
  ...
  if (isNew) {
    ...
    if (offsetByNextNode !== void 0) {
      ...
      offset = findChildNodeIndex(childNodes, (_a = next.find((n) => n.tag !== HONO_PORTAL_ELEMENT && n.e)) == null ? void 0 : _a.e) ?? -1;
    }
    if (offset === -1) {
      isNew = true;
    }
...
var build = (context, node, children) => {
  ...
  try {
    ...
    if (((_a = children[0]) == null ? void 0 : _a.tag) === "" && children[0][DOM_ERROR_HANDLER]) {
    ...
    for (let i = 0; i < children.length; i++) {
      ...
      if (child) {
        if (typeof child.tag === "function" && !child.tag[DOM_INTERNAL_TAG]) {
          ...
          if ((_b = context[5]) == null ? void 0 : _b.length) {
        ...
        if (oldChild) {
          if (isNodeString(child)) {
            ...
            if (typeof child.tag === "function") {
              ...
              if (!oldChild.f && ((oldChild.o || oldChild) === child.o || ((_d = (_c = oldChild.tag)[DOM_MEMO]) == null ? void 0 : _d.call(_c, pP, oldChild.props))) && isSameContext(oldContexts, oldChild[DOM_STASH][2])) {
                oldChild.s = true;
              }
            }
            child = oldChild;
        ...
        if (prevNode && !prevNode.s && !child.s) {
          for (let p = prevNode; p && !isNodeString(p); p = (_e = p.vC) == null ? void 0 : _e.at(-1)) {
            p.nN = child;
          }
        }
        prevNode = child;
    ...
    const [errorHandlerContext, errorHandler, errorHandlerNode] = ((_f = node[DOM_STASH]) == null ? void 0 : _f[3]) || [];
    if (errorHandler) {
...
var updateSync = (context, node) => {
  var _a, _b;
  (_a = node[DOM_STASH][2]) == null ? void 0 : _a.forEach(([c, v]) => {
    c.values.push(v);
  });
  try {
  ...
  (_b = node[DOM_STASH][2]) == null ? void 0 : _b.forEach(([c]) => {
    c.values.pop();
  });
...
var documentMetadataTag = (tag, props, preserveNodeType, supportSort, supportBlocking) => {
  ...
  const ref = composeRef(props.ref, (e) => {
    ...
    let promise = blockingPromiseMap[_a = e.getAttribute(key)] || (blockingPromiseMap[_a] = new Promise(
      (resolve, reject) => {
...
var ErrorBoundary = ({ children, fallback, fallbackRender, onError }) => {
  ...
  res[DOM_ERROR_HANDLER] = (err) => {
    ...
    return (fallbackRender == null ? void 0 : fallbackRender(err)) || fallback;
  };
  return res;
};
var Suspense = ({
...
//# sourceMappingURL=chunk-5G2PSIJ3.js.map
