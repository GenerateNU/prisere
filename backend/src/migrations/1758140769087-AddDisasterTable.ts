...
export class AddDisasterTable1758140769087 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "fema_disaster" ("femaId" character varying NOT NULL, "disasterNumber" integer NOT NULL, "state" integer NOT NULL, "declarationDate" date NOT NULL, "startDate" date, "endDate" date, "fipsCountyCode" integer NOT NULL, "declarationType" character varying NOT NULL, "designatedArea" character varying NOT NULL, "designatedIncidentTypes" character varying NOT NULL, CONSTRAINT "PK_66d22c77dd61fd66f461ddae43a" PRIMARY KEY ("femaId"))`
        );
    }
