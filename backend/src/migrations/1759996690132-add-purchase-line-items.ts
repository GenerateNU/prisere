...
export class AddPurchaseLineItems1759996690132 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "purchase_line_item" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" character varying(400), "quickBooksId" integer NOT NULL, "purchaseId" uuid NOT NULL, "amountCents" integer NOT NULL, "category" character varying(100), "type" "public"."purchase_line_item_type_enum" NOT NULL, "dateCreated" TIMESTAMP NOT NULL DEFAULT now(), "lastUpdated" TIMESTAMP NOT NULL DEFAULT now(), "quickbooksDateCreated" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_218243ae12106f5db20e1995065" UNIQUE ("purchaseId", "quickBooksId"), CONSTRAINT "PK_3f193d6f0c52c01fae98e01e9fe" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
