...
export class Quickbooks1758498816652 implements MigrationInterface {
    name = 'Quickbooks1758498816652'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."company_external_source_enum" AS ENUM('quickbooks')`);
        await queryRunner.query(`CREATE TABLE "company_external" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "source" "public"."company_external_source_enum" NOT NULL, "externalId" character varying NOT NULL, "companyId" uuid NOT NULL, CONSTRAINT "PK_f4bc596bf38d3448f505eeb9bbc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "quickbooks_session" ("accessToken" character varying NOT NULL, "refreshToken" character varying NOT NULL, "accessExpiryTimestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "refreshExpiryTimestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "companyId" uuid NOT NULL, CONSTRAINT "REL_f038467297bfac7a3c4a163bfd" UNIQUE ("companyId"), CONSTRAINT "PK_21e3f1c58eec6d7fe36cbe5aab1" PRIMARY KEY ("accessToken"))`);
        await queryRunner.query(`CREATE TABLE "quickbooks_pending_o_auth" ("stateId" character varying NOT NULL, "initiatorUserId" uuid NOT NULL, "consumedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_406f18a63e1433ce754641634b9" PRIMARY KEY ("stateId"))`);
