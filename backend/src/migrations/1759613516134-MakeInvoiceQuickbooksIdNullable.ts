...
export class MakeInvoiceQuickbooksIdNullable1759613516134 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "invoice" ADD CONSTRAINT "UQ_384cac72df716a34770ccd55f95" UNIQUE ("quickbooksId", "companyId")`
        );
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "invoice" ADD CONSTRAINT "UQ_384cac72df716a34770ccd55f95" UNIQUE ("companyId", "quickbooksId")`
        );
    }
}
