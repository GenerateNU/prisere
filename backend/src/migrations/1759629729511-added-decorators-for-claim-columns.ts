...
export class AddedDecoratorsForClaimColumns1759629729511 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "company" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "lastQuickBooksImportTime" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_056f7854a7afdba7cbd6d45fc20" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying, "companyId" uuid, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "fema_disaster" ("id" character varying NOT NULL, "disasterNumber" integer NOT NULL, "fipsStateCode" integer NOT NULL, "declarationDate" TIMESTAMP NOT NULL, "incidentBeginDate" TIMESTAMP, "incidentEndDate" TIMESTAMP, "fipsCountyCode" integer NOT NULL, "declarationType" character varying NOT NULL, "designatedArea" character varying NOT NULL, "designatedIncidentTypes" character varying NOT NULL, CONSTRAINT "PK_355266f9e9404519f7bb4753a2e" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE TABLE "claim" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE, "companyId" uuid NOT NULL, "disasterId" character varying NOT NULL, CONSTRAINT "PK_466b305cc2e591047fa1ce58f81" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
