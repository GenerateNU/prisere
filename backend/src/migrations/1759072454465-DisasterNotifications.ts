...
export class DisasterNotifications1759072454465 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."disasterNotification_notificationstatus_enum" AS ENUM('unread', 'read')`
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "notifications" ADD CONSTRAINT "FK_520e2b43d1ce6828e112c82927e" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
            `ALTER TABLE "notifications" ADD CONSTRAINT "FK_4313c838cd09ff0a0f599b986a8" FOREIGN KEY ("femaDisasterId") REFERENCES "fema_disaster"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "FK_4313c838cd09ff0a0f599b986a8"`);
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "FK_520e2b43d1ce6828e112c82927e"`);
