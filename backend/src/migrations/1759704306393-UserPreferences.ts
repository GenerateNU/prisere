...
export class UserPreferences1759704306393 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."user_preferences_notificationfrequency_enum" AS ENUM('daily', 'weekly')`
        );
        await queryRunner.query(
            `CREATE TABLE "user_preferences" ("userId" uuid NOT NULL, "emailEnabled" boolean NOT NULL DEFAULT true, "webNotificationsEnabled" boolean NOT NULL DEFAULT true, "notificationFrequency" "public"."user_preferences_notificationfrequency_enum" NOT NULL DEFAULT 'daily', CONSTRAINT "PK_b6202d1cacc63a0b9c8dac2abd4" PRIMARY KEY ("userId"))`
        );
        await queryRunner.query(
            `ALTER TABLE "user_preferences" ADD CONSTRAINT "FK_b6202d1cacc63a0b9c8dac2abd4" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
    }
