...
export class AddClaimDocRelation1764575649956 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "claim_uploaded_documents" ADD CONSTRAINT "FK_ee133e8c24ee149c2fd05998e41" FOREIGN KEY ("documentId") REFERENCES "document"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "document" ADD CONSTRAINT "REL_6d01193b2c2c5039535f28f2f9" UNIQUE ("claimId")`);
