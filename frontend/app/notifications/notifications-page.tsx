        ...
        <div className="p-8">
            <div className="mb-6">
                <div className="mt-3 flex gap-2">
                    <Link href="/" className="text-sm font-medium text-red-800 hover:text-red-900 underline">
                        Prisere Home 🪷
                    </Link>
                </div>
                ...
                {sortedData?.map((notification: any) => (
                    ...
                    >
                        ...
                        <div className="flex justify-between items-start mb-3">
                            <div>
                                <p className="text-sm text-gray-600">Disaster #{notification.disasterNumber}</p>
                            </div>
                                ...
                                <button
                                    onClick={() =>
                                        setDropdowns((prev) => ({
                                            ...prev,
                                            openDropdown:
                                                prev.openDropdown === notification.id ? null : notification.id,
                                        }))
                                    }
                        ...
                        {notification.locationAddress && (
                            <div className="mb-3 p-3 bg-gray-50 rounded">
                                <p className="font-semibold text-sm text-gray-700 mb-1">Affected Business Location:</p>
                                <p className="text-sm">{notification.locationAddress.streetAddress}</p>
                                <p className="text-sm">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                {modal.selectedNotification.femaDisaster?.fipsStateCode}{" "}
                                                {modal.selectedNotification.femaDisaster?.fipsCountyCode}
                                            </p>
                                        </div>
                                        <div>
                                ...
                                {modal.selectedNotification.locationAddress && (
                                    <div>
                                        ...
                                        <div className="bg-gray-50 p-3 rounded">
                                            ...
                                            <p>
                                                {modal.selectedNotification.locationAddress.city},{" "}
                                                {modal.selectedNotification.locationAddress.stateProvince}{" "}
                                                {modal.selectedNotification.locationAddress.postalCode}
                                            </p>
                                            {modal.selectedNotification.locationAddress.company && (
                                                <p className="mt-2">
                                                    <span className="font-medium">Company:</span>{" "}
                                                    {modal.selectedNotification.locationAddress.company.name}
                                                </p>
                                            )}
                                        </div>
                                    </div>
            ...
            <div className="mt-8 flex items-center justify-between border-t pt-4">
                <div className="text-sm text-gray-600">Page {pagination.currentPage}</div>
