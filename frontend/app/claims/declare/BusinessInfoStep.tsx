...
export default function BusinessInfoStep({ businessInfo, setInfo, handleStepForward, handleStepBack, locations }: Props) {
    ...
    return (
        <div className="flex flex-col gap-[40px] h-full">
            ...
            <Card className="flex flex-col gap-8 p-[25px] pb-[30px] border-1">
                ...
                <div className="">
                    ...
                    {errors.businessOwner && (
                        <p className="text-red-500 text-sm mt-1">{errors.businessOwner}</p>
                    )}
                </div>
                <div className="w-1/2">
                    ...
                    <Select value={businessType} onValueChange={setBusinessType}>
                        ...
                        <SelectContent>
                            {businessTypes.map((type) => <SelectItem key={type} value={type} className="text-[16px]">{type}</SelectItem>)}
                        </SelectContent>
                    </Select>
                </div>
                <div>
            ...
            <div className="flex justify-end gap-[25px]">
                <Button className="flex-1/2 px-[20px] py-[12px]  h-fit rounded-50 text-[16px]"
