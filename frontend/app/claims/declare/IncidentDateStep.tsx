                ...
                <div className="flex flex-col items-center justify-center h-full gap-8 self-center">
                    <div className="w-2xl flex flex-col gap-8">
                        <div className="flex flex-col gap-5">
                            <h3 className="text-4xl font-bold text-center">When did the disaster occur?</h3>
                            <p className="text-center w-full">
                                If you are currently still collecting expenses for this disaster, leave the end date
                                blank.
                            </p>
                        </div>
