            ...
            {steps.map((s) => (
                <div key={s.step} className={`flex items-center w-full gap-[30px] ${s.step === 5 && "max-w-[96px]"}`}>
                    <div className="flex flex-col items-center gap-[10px] min-w-[96px]">
                        <div
                            className={`rounded-[100px] w-[36px] h-[36px] ${s.step <= step - 1 ? "bg-[#646464]" : "bg-[#8d8d8d99]"} text-white flex items-center justify-center`}
                        >
                    ...
                    {s.step !== 5 && (
                        <hr
                            className={`flex-grow ${s.step < step - 1 ? " bg-[#646464]" : "bg-[#8d8d8d99]"} h-[1px] w-full border-none`}
                        />
                    )}
                </div>
            ))}
